  ...
  return (
    <section className="py-20 px-4 relative overflow-hidden">
      <div className="container mx-auto max-w-4xl text-center relative z-10">
        ...
        >
          Create scroll-stopping YouTube thumbnails, snappy scripts, and
          engaging video descriptions effortlessly. Let your creativity shine
          with tools made for creators, by creators.
        </motion.p>
